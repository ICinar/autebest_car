...
/** MSR default kernel bits */
#define MSR_IDLE_BITS		(MSR_SPE | MSR_EE | MSR_CE | MSR_ME)

/** MSR default user bits */
#define MSR_USER_BITS		(MSR_EE | MSR_CE | MSR_ME | MSR_PR | MSR_IS | MSR_DS)
