// based on Libraries/CMSIS/Device/ST/STM32F4xx/Include/stm32f4xx.h
...
typedef struct
{
  ...
  //__IO uint32_t CDR;    /*!< ADC common regular data register for dualAND triple modes,                            Address offset: ADC1 base address + 0x308 */
} ADC_Common_TypeDef;
